 ...
 *
 * No stat tiles yet: the marketplace-wide counts that belong here (GMV,
 * active organizations, redemptions) have no backend contract to read from,
 * and tiles filled with invented numbers would be worse than none.
 */
